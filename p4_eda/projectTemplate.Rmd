...
### Plot One
```{r echo=FALSE, fig.height=9, Plot_One}
a<-c(fill="green",alpha=0.5)
r1 <- ggplot(data=w, aes(x=fixed.acidity)) + geom_density(fill="green",alpha=0.5)
r2 <- ggplot(data=w, aes(x=volatile.acidity)) + geom_density(fill="green",alpha=0.5)
r3 <- ggplot(data=w, aes(x=citric.acid)) + geom_density(fill="green",alpha=0.5)
r4 <- ggplot(data=w, aes(x=pH)) + geom_density(fill="green",alpha=0.5)
r5 <- ggplot(data=w, aes(x=density)) + geom_density(fill="green",alpha=0.5)
r6 <- ggplot(data=w, aes(x=residual.sugar)) + geom_density(fill="green",alpha=0.5)
r7 <- ggplot(data=w, aes(x=total.sulfur.dioxide)) + geom_density(fill="green",alpha=0.5)
r8 <- ggplot(data=w, aes(x=free.sulfur.dioxide)) + geom_density(fill="green",alpha=0.5)
r9 <- ggplot(data=w, aes(x=alcohol)) + geom_density(fill="green",alpha=0.5)
r10 <- ggplot(data=w, aes(x=sulphates)) + geom_density(fill="green",alpha=0.5)
r11 <- ggplot(data=w, aes(x=chlorides)) + geom_density(fill="green",alpha=0.5)
r12 <- ggplot(data=w, aes(x=quality)) + geom_bar(fill="green",alpha=0.5)

grid.arrange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, ncol=2, 
             top="Distributions of the physicochemical measurements of red wines",
...
### Plot Three
```{r echo=FALSE, fig.height=8, Plot_Three}
grid.arrange(q1,q2,q3,q4,q5,q6,q7,q8,q9,q10, ncol=2,
             heights=rep(unit(1.3,"inch"), 6),
