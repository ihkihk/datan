...
plotVar <- function(v,d) {
  ...
  q3 <- qplot(" ", data=d, y=v, geom="boxplot", ylab=substitute(v)[3])
...
ggpairs(w[,2:14], axisLabels = "internal", title="Red Wines",
...
Below is shown a table with the correlations of quality to the other variables.
