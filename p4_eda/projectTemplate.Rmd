...
for (mf in f) {
    ...
    w.m$predicted.quality <- apply(w.m, 1, function(x) which.max(x[c(13:18)])+2)
...
It also has a relatively low AIC (Akaike Information Criterion), meaning that its "difficulty-to-prediction" ratio is one of the best among the tried models.
